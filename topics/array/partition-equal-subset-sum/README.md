...
**Problem:** [leetcode.com/problems/partition-equal-subset-sum](https://leetcode.com/problems/partition-equal-subset-sum/)  
**Solution:** [`0416-partition-equal-subset-sum.java`](./0416-partition-equal-subset-sum.java)
<!-- PROBLEM:END -->
